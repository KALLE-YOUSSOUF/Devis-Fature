	...
	<div class="col-md-12">
		...
		<div class="panel panel-primary">
			<div class="panel-heading">
				<div class="page-heading"> <i class="glyphicon glyphicon-edit"></i> Liste de produits</div>
			</div> <!-- /panel-heading -->
			<div class="panel-body">
				...
				<div class="div-action pull pull-right" style="padding-bottom:20px;">
					<button class="btn btn-success button1" data-toggle="modal" id="addProductModalBtn" data-target="#addProductModal"> <i class="glyphicon glyphicon-plus-sign"></i> Ajouter Produit </button>
				</div> <!-- /div-action -->				
    	...
    	<form class="form-horizontal" id="submitProductForm" action="php_action/createProduct.php" method="POST" enctype="multipart/form-data">
	      ...
	      <div class="modal-body" style="max-height:450px; overflow:auto;">
	      	...
	      	<div class="form-group">
	        	<label for="productImage" class="col-sm-3 control-label">Image produit: </label>
	        	<label class="col-sm-1 control-label">: </label>
				    <div class="col-sm-8">
					    <!-- the avatar markup -->
							<div id="kv-avatar-errors-1" class="center-block" style="display:none;"></div>							
					    <div class="kv-avatar center-block">					        
					        <input type="file" class="form-control" id="productImage" placeholder="Nom d'image" name="productImage" class="file-loading" style="width:auto;"/>
					    </div>
	        ...
	        <div class="form-group">
	        	<label for="rate" class="col-sm-3 control-label">Prix unitaire: </label>
	        	<label class="col-sm-1 control-label">: </label>
				    <div class="col-sm-8">
				      <input type="text" class="form-control" id="rate" placeholder="Prix unitaire" name="rate" autocomplete="off">
				    </div>
	        </div> <!-- /form-group-->	     	        

	        <div class="form-group">
	        	<label for="categoryName" class="col-sm-3 control-label">Nom categorie: </label>
	        	<label class="col-sm-1 control-label">: </label>
				    <div class="col-sm-8">
				      <select type="text" class="form-control" id="categoryName" placeholder="Nom produit" name="categoryName" >
...
<div class="modal fade" id="editProductModal" tabindex="-1" role="dialog">
  <div class="modal-dialog">
    <div class="modal-content">
	      ...
	      <div class="modal-header">
	        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
	        <h4 class="modal-title"><i class="fa fa-edit"></i> Modifier produit</h4>
	      </div>
	      <div class="modal-body" style="max-height:450px; overflow:auto;">
	      	...
	      	<div class="div-result">
				  ...
				  <ul class="nav nav-tabs" role="tablist">
				    ...
				    <li role="presentation"><a href="#productInfo" aria-controls="profile" role="tab" data-toggle="tab">Information produit</a></li>    
				  </ul>
				  ...
				  <div class="tab-content">
				    ...
				    <div role="tabpanel" class="tab-pane active" id="photo">
			      	...
			      	<div class="form-group">
			        	<label for="editProductImage" class="col-sm-3 control-label">Selectionner Photo: </label>
			        	<label class="col-sm-1 control-label">: </label>
						    <div class="col-sm-8">
							    <!-- the avatar markup -->
									<div id="kv-avatar-errors-1" class="center-block" style="display:none;"></div>							
				    ...
				    <div role="tabpanel" class="tab-pane" id="productInfo">
			        	...
			        	<label class="col-sm-1 control-label">: </label>
						    <div class="col-sm-8">
						      <input type="text" class="form-control" id="editProductName" placeholder="Nom produit" name="editProductName" autocomplete="off">
						    </div>
			        </div> <!-- /form-group-->	    
			        ...
			        <div class="form-group">
			        	<label for="editRate" class="col-sm-3 control-label">Prix unitaire: </label>
			        	<label class="col-sm-1 control-label">: </label>
						    <div class="col-sm-8">
						      <input type="text" class="form-control" id="editRate" placeholder="Prix unitaire" name="editRate" autocomplete="off">
						    </div>
			        </div> <!-- /form-group-->	     	        
			        <div class="form-group">
			        	<label for="editCategoryName" class="col-sm-3 control-label">Nom categorie: </label>
			        	<label class="col-sm-1 control-label">: </label>
						    <div class="col-sm-8">
