...
if($result->num_rows > 0) { 
 ...
 while($row = $result->fetch_array()) {
 	...
 	if($row[2] == 1) {
 		...
 		// deactivate member
 		$activeCategories = "<label class='label label-danger'>Non disponible</label>";
 	}
	...
	<div class="btn-group">
	  ...
	  <ul class="dropdown-menu">
	    <li><a type="button" data-toggle="modal" id="editCategoriesModalBtn" data-target="#editCategoriesModal" onclick="editCategories('.$categoriesId.')"> <i class="glyphicon glyphicon-edit"></i> Modifier</a></li>
