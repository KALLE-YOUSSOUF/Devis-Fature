...
if($_POST) {	
 ...
 $orderDate = date('Y-m-d', strtotime($_POST['orderDate']));
  ...
  $totalAmountValue     = $_POST['totalAmountValue'];
	...
	$sql = "UPDATE orders SET order_date = '$orderDate', client_id = '$clientName1', sub_total = '$subTotalValue', vat = '$vatValue', total_amount = '$totalAmountValue' WHERE order_id = {$orderId}";	
	$connect->query($sql);
