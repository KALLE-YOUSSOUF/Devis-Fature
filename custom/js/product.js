	...
	$("#addProductModalBtn").unbind('click').bind('click', function() {
		...
		$("#productImage").fileinput({
	      overwriteInitial: true,
		    ...
		    removeTitle: 'Annuler ou réinitialiser les modifications',
		...
		$("#submitProductForm").unbind('submit').bind('submit', function() {
			...
			if(productImage == "") {
				$("#productImage").closest('.center-block').after('<p class="text-danger">Image de produit est obligatoire</p>');
			...
			if(productName == "") {
				$("#productName").after('<p class="text-danger">Nom de produit est obligatoire</p>');
			...
			if(rate == "") {
				$("#rate").after('<p class="text-danger">Le taux est obligatoire</p>');
			...
			if(categoryName == "") {
				$("#categoryName").after('<p class="text-danger">Le nom de catégorie est obligatoire</p>');
			...
			if(productStatus == "") {
				$("#productStatus").after('<p class="text-danger">Status de produit est obligatoire</p>');
	...
	if(productId) {
		...
		$.ajax({
		  ...
		  //     overwriteInitial: true,
			 ...
			 //    elErrorContainer: '#kv-avatar-errors-1',
			 //    msgErrorClass: 'alert alert-block alert-danger',
			 //    defaultPreviewContent: '<img src="d_f/'+response.product_image+'" alt="Profile Image" style="width:100%;">',
			 //    layoutTemplates: {main2: '{preview} {remove} {browse}'},								    
		  // 		allowedFileExtensions: ["jpg", "png", "gif", "JPG", "PNG", "GIF"]
				// });  
				...
				$("#editProductForm").unbind('submit').bind('submit', function() {
					...
					if(quantity == "") {
						$("#editQuantity").after('<p class="text-danger">La quantité est obligatoire</p>');
					...
					if(rate == "") {
						$("#editRate").after('<p class="text-danger">Le taux est obligatoire</p>');
					...
					if(categoryName == "") {
						$("#editCategoryName").after('<p class="text-danger">Le nom de catégorie est obligatoire</p>');
					...
					if(productStatus == "") {
						$("#editProductStatus").after('<p class="text-danger">Status produit est obligatoire</p>');
				...
				$("#updateProductImageForm").unbind('submit').bind('submit', function() {					
					...
					if(productImage == "") {
						$("#editProductImage").closest('.center-block').after('<p class="text-danger">Image de produit est obligatoire</p>');
