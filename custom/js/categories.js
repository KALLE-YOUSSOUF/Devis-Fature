...
$(document).ready(function() {
	...
	$('#addCategoriesModalBtn').unbind('click').bind('click', function() {
		...
		$("#submitCategoriesForm").unbind('submit').bind('submit', function() {
			...
			if(categoriesName == "") {
				$("#categoriesName").after('<p class="text-danger">Le nom du marque est obligatoire</p>');
			...
			if(categoriesStatus == "") {
				$("#categoriesStatus").after('<p class="text-danger">Le nom du marque est obligatoire</p>');
		...
		$.ajax({
			...
			success:function(response) {
				...
				$("#editCategoriesForm").unbind('submit').bind('submit', function() {
					...
					if(categoriesName == "") {
						$("#editCategoriesName").after('<p class="text-danger">Le nom du marque est obligatoire</p>');
					...
					if(categoriesStatus == "") {
						$("#editCategoriesStatus").after('<p class="text-danger">Le nom du marque est obligatoire</p>');
