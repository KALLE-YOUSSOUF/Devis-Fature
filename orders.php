...
<div class="panel panel-primary">
	<div class="panel-heading">
		...
		<?php if($_GET['o'] == 'add') { ?>
  		<i class="glyphicon glyphicon-plus-sign"></i>	Ajouter Devis
		<?php } else if($_GET['o'] == 'manord') { ?>
			<i class="glyphicon glyphicon-edit"></i> Gestion de Devis
		<?php } else if($_GET['o'] == 'editOrd') { ?>
			<i class="glyphicon glyphicon-edit"></i> Modifier Devis
		<?php } ?>
	...
	<div class="panel-body">
		...
		<?php if($_GET['o'] == 'add') { 
  		...
  		<form class="form-horizontal" method="POST" action="php_action/createOrder.php" id="createOrderForm">
			  ...
			  <div class="form-group">
	        	<label for="clientName1" class="col-sm-2 control-label">Nom Client : </label>
	        	
				    <div class="col-sm-10">
				      <select type="text" class="form-control" id="clientName1" placeholder="Nom produit" name="clientName1" >
		...
		// /else manage order
  		...
  		<form class="form-horizontal" method="POST" action="php_action/editOrder.php" id="editOrderForm">
			  ...
			  <div class="form-group">
			    <label for="orderDate" class="col-sm-2 control-label">Date Devis</label>
			    <div class="col-sm-10">
			  ...
			  <div class="form-group">
			        	<label for="clientName1" class="col-sm-2 control-label">Nom client: </label>
						    <div class="col-sm-10">
						      <select type="text" class="form-control" id="clientName1" name="clientName1" >
			  ...
			  <div class="form-group editButtonFooter">
			    ...
			    <button type="submit" id="editOrderBtn" data-loading-text="Loading..." class="btn btn-success"><i class="glyphicon glyphicon-ok-sign"></i> Enregistrer</button>
...
<div class="modal fade" tabindex="-1" role="dialog" id="removeOrderModal">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
        <h4 class="modal-title"><i class="glyphicon glyphicon-trash"></i> Supprimer un Devis</h4>
      </div>
      <div class="modal-body">

      	<div class="removeOrderMessages"></div>

        <p>Etes vous sûr de supprimer le Devis ?</p>
      </div>
